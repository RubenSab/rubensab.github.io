...
**CONS**: Requires the usag of Make, not familiar to non-developers or not techy people.
...
5. Add a release title (e.g., Initial Release) and description (optional).

6. Attach your .tar.gz or .zip file by dragging it into the release page.
...
With just a few simple (and reproducible, I hope) steps, we’ve brought our idea into production, making it available for everyone to easily install and use.
